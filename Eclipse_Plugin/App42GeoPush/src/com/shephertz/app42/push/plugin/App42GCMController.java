...
public class App42GCMController {
	 ...
	 * @return true, if is play service available
	 */
	 ...
	 *
	 * @param context the context
	 * @return true, if is app42 registerd
	 */
	 ...
	 *
	 * @param context the context
	 * @param googleProjectNo the google project no
	 ...
	 *
	 * @param userName the user name
	 * @param deviceToen the device toen
	 * @param callBack the call back
	 */
	public static void registerOnApp42(String userName,String deviceToen,final App42GCMListener callBack){
		//App42API.buildPushNotificationService().subscribeToChannel(userName, "English", deviceToen, DeviceType.ANDROID,  new App42CallBack() {
	...
	public interface App42GCMListener {
		...
		/**
		 * On gcm registration id.
		 *
		 * @param gcmRegId the gcm reg id
		 */
